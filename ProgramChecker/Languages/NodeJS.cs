...
namespace ProgramChecker.Languages
{
    ...
    {
        private new static string nameScript = "nodejs.cmd";

        public NodeJS(Check check) : base(check, "js")
        {
        }
        ...
        public override bool compile()
        {
            ...
            string testFile = $"{pathCompile}check_{check.checkId}.js";
        ...
        public override Process createTestProcess(string testFile, string testSrc)
        {
            var compile = new Process
            {
                StartInfo = new ProcessStartInfo
                {
                    FileName = pathScript + "nodejs.cmd",
                    Arguments = testFile,
                    RedirectStandardOutput = true,
                    RedirectStandardError = true,
